...
**Pro Tip:** When requesting device frames, include details about the device's environment to make mockups more realistic. For example, specify desktop wallpaper for browser frames, or add reflections and shadows to mobile devices.
...
| Size | Usage | Value |
|------|-------|-------|
| H1 Display | Large headlines | 2.5rem - 3rem (40-48px) |
| H2 Heading | Section headings | 1.75rem - 2rem (28-32px) |
| H3 Subheading | Subsection headings | 1.25rem - 1.5rem (20-24px) |
| Body Text | Paragraphs | 1rem (16px) |
| Small Text | Secondary content | 0.875rem (14px) |
| Micro / Caption | Fine print | 0.75rem (12px) |
...
Use this interactive tool to craft precise typography prompts:
...
- **Delayed Animation** - Timed entrance
- **Blur Effect** - Focus transition
- **Rotate** - Spinning entrance
- **Sequence** - Staggered group animation
...
**Note:** When requesting layouts, specify details like spacing, corner radius, shadows, and interactions. For responsive designs, mention how layouts should adapt across different screen sizes.
