...
- **Slide In** - Element moves into view from off-screen
- **Bounce** - Element bounces into place
- **Pulse** - Rhythmic scaling effect
- **Delayed Animation** - Animation starts after a delay
- **Blur Effect** - Focus transition effect
- **Rotate** - Spinning or rotation effect
- **Sequence** - Multiple elements animate in sequence
