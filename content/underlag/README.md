...
Each `.md` file here **is** an article. `lib/underlag.ts` reads this directory
...
Frontmatter fields are documented in `.claude/skills/underlag/SKILL.md`.
...
stay out of `sitemap.xml`, and do not count toward `/underlag` having content.
